...
import com.example.mathengerapi.services.mathCompiler.MathCompiler;
import org.junit.Test;

import static org.junit.Assert.assertEquals;

public class MathCompilerSimpleExpressionsTest {
    private final MathCompiler compiler = new MathCompiler();

    @Test
    public void compiles2NumbersAdditionToLatex() {
        var expr = "5+2=7";
        var expected = "5 + 2 = 7";
        var result = compiler.toLatex(expr);
